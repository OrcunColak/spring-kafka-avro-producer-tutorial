...
import com.colak.springtutorial.config.PublisherListener;
...
@SpringBootTest
@Testcontainers
class KafkaAvroProducerWithListenerTest {
    ...
    static void overrideProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("spring.kafka.properties.schema.registry.url", KafkaAvroProducerWithListenerTest::getSchemaRegistryUrl);
    }
